...
{
    public sealed partial class ListObjectControl : UserControl
    {
        public ListObjectControl()
        {
        ...
        public static readonly DependencyProperty ObjectProperty =
            DependencyProperty.Register("Object", typeof(object), typeof(ListObjectControl), new PropertyMetadata(null, OnValuesChanged));

        private static void OnValuesChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
        {
            (sender as ListObjectControl).OnValuesChanged(e);
        }
