...
{
    public sealed partial class ExceptionObjectControl : UserControl
    {
        public ExceptionObjectControl()
        {
        ...
        public static readonly DependencyProperty ObjectProperty =
            DependencyProperty.Register("Object", typeof(object), typeof(ExceptionObjectControl), new PropertyMetadata(null, OnValuesChanged));

        private static void OnValuesChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
        {
            (sender as ExceptionObjectControl).OnValuesChanged(e);
        }
        ...
        private void OnValuesChanged(DependencyPropertyChangedEventArgs e)
        {
            ...
            TextBlockExceptionType.Text = Object.GetType().ToString();

            TextBlockExceptionDetails.Text = Object.ToString();
        }
    }
}
